...
| File | Description |
|------|-------------|
| `epstein-unified.html` | **Main deliverable.** Two-page interactive investigation — open in any browser |
| `epstein-accusations.csv` | Structured data: 122 individuals with sector, status, travel record, connection summary, consequence, and source citations |
| `README.md` | This file |
...
| `plane` | true / false / unclear / claimed_never |
| `island` | true / false / unclear / claimed_never |
| `connection_summary` | Documented connection to Epstein (truncated to 300 chars) |
